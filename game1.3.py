...
e1 = drawpad.create_rectangle(0,540,425,570, fill="white")
e2 = drawpad.create_rectangle(700,500,800,600, fill="white")
e3 = drawpad.create_rectangle(700,0,800,560, fill="white")
e4 = drawpad.create_rectangle(300,150,450,300, fill="white")
e5 = drawpad.create_rectangle(250,0,550,50, fill="white")
e6 = drawpad.create_rectangle(110,190,160,470, fill="white")
e7 = drawpad.create_rectangle(500,430,550,495, fill="white")
e8 = drawpad.create_rectangle(230,180,290,240, fill="white")
